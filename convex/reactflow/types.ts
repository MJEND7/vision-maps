...
export const nodeValidator = () =>
    v.optional(v.object({
        ...
        extent: v.optional(v.union(v.literal("parent"), coordinateExtent, v.null())),
...
const edgeReplaceChange = <T extends Validator<Value, "required", any>>(
    data: T,
) =>
    v.object({
        id: v.string(),
