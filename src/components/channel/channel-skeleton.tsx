// components/skeletons/channel-skeleton.tsx
export function ChannelSkeleton() {
  return (
    <div className="h-full px-20 py-6 space-y-8 animate-pulse">
      {/* Title and description skeleton */}
      <div className="space-y-4">
        <div className="h-9 bg-muted rounded-lg w-1/3" />
...
// components/skeletons/node-skeleton.tsx
...
export function NodeListSkeleton({ count = 5, showLoadMore = false }: NodeListSkeletonProps) {
  return (
