...
export default function AuthComponent({ variant, onSwitchVariant }: AuthComponentProps) {
            ...
            <div className="bg-background border border-border h-full sm:h-auto sm:rounded-xl rounded-b-xl shadow-lg sm:p-8 p-4 pt-15">
                <div className="text-center mb-6">
                    ...
                    <p className="text-muted-foreground font-body">
                        {isSignIn
                            ? "Continue with a platform or enter your details."
                ...
                {!isSignIn && <div id="clerk-captcha"></div>}

                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="email" className="block text-sm font-medium text-foreground mb-2">
                            {isSignIn ? "Email address" : "Email *"}
                        </label>
                        <Input
                            id="email"
                            type="email"
                            ...
                            className="h-12"
                            placeholder={isSignIn ? "Enter email" : "Enter your email"}
                            required
                        />
                    </div>
