...
const buttonVariants = cva(
  ...
  rounded-lg text-primary text-sm transition-all disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed disabled:opacity-50
  ...
  aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive relative overflow-hidden `,
  {
    variants: {
      variant: {
        ...
        outline:
          "border bg-background backdrop-blur-[3px] shadow-xs hover:text-accent-foreground ease-in-out transition-all hover:text-accent-foreground ease-in-out transition-all duration-300 hover:[background-image:radial-gradient(ellipse_at_bottom,_rgba(192,192,192,0.4)_0%,_rgba(192,192,192,0.2)_30%,_transparent_60%)] dark:bg-input/30 border-accent dark:hover:bg-input/50 dark:hover:[background-image:radial-gradient(ellipse_at_bottom,_rgba(255,255,255,0.3)_0%,_rgba(255,255,255,0.15)_30%,_transparent_60%)]",
        secondary:
