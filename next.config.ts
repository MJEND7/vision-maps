        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.convex.site https://react-tweet.vercel.app https://*.uploadthing.com https://*.clerk.accounts.dev https://*.clerk.dev https://challenges.cloudflare.com https://*.cloudflare.com https://*.convex.cloud wss://*.convex.cloud",
